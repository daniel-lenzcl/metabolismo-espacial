...
public class relacoes : MonoBehaviour
{
    ...
    public void GetCasas(string tCasa)
    {
        ...
        float t = Mathf.Ceil(levelgenerator_local_relacoes.totalPessoas / pessoasPcasa);
    ...
    public void GetTrabalhos(string tTrabalho)
    {
        ...
        levelgenerator_local_relacoes.totalTrabalhos = (int)Mathf.Ceil(levelgenerator_local_relacoes.totalPessoas / pessoasPtrabalho);
